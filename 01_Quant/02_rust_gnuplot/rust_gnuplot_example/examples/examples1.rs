use gnuplot::{
    AlignType::{AlignCenter, AlignLeft, AlignRight, AlignTop},
    ArrowheadType::Closed,
    AutoOption::{Auto, Fix},
    AxesCommon,
    BorderLocation2D::{Bottom, Left},
    Coordinate::{Axis, Graph},
    DashType::{Dash, DotDash, DotDotDash, SmallDot},
    Figure,
    FillRegionType::{Above, Below, Between},
    LabelOption::{
        Font, MarkerColor, MarkerSize, MarkerSymbol, Rotate, TextAlign, TextColor, TextOffset,
    },
    LegendOption::{Horizontal, Placement, Title},
    PlotOption::{
        ArrowSize, ArrowType, Caption, Color, FillAlpha, FillRegion, LineStyle, LineWidth,
        PointSize, PointSymbol,
    },
    TickOption::Mirror,
};
